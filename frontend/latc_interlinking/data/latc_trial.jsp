...
header ("Content-Disposition: attachment; filename=http://linker.sindice.com/runtime-results/2011-02-10/dbpedia-lgd_airport.xml/links.nt");
header("Content-Length: " . filesize("http://linker.sindice.com/runtime-results/2011-02-10/dbpedia-lgd_airport.xml/links.nt"));
$fp = fopen("http://linker.sindice.com/runtime-results/2011-02-10/dbpedia-lgd_airport.xml/links.nt", "r");
fpassthru($fp);
?>
<!------------------------------------------------------------------>
<div id="header">
